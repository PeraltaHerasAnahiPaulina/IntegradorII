...
<!-- Footer -->
  <footer class="sticky-footer bg-white">
    ...
    <!-- Page level plugins -->
    <script src="{{asset('estilos/vendor/chart.js/Chart.min.js')}}"></script>
    <script src="{{asset('vendor/datatables/dataTables.bootstrap4.min.js')}}"></script>
    <!-- Page level custom scripts -->
    <script src="{{asset('estilos/js/demo/chart-area-demo.js')}}"></script>
    <script src="{{asset('estilos/js/demo/chart-pie-demo.js')}}"></script>
